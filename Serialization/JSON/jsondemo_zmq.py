...
def driver(name, iters, vec_len, port):
    print(
        "Driver program: Name = {}, Num Iters = {}, Vector len = {}, Peer port = {}".format(name, iters, vec_len, port))
...
def parseCmdLineArgs():
    ...
    parser.add_argument("-p", "--port", type=int, default=5555,
                        help="Port where the server part of the peer listens and client side connects to (default: 5555)")
    # parse the args
